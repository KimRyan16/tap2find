                ...
                >
                  ...
                  <td class="px-3 py-2 sm:px-6 sm:py-4">
                    <div class="flex items-center gap-2 sm:gap-3">
                      <div
                        class="w-7 h-7 sm:w-9 sm:h-9 rounded-full overflow-hidden bg-blue-100 text-blue-600 grid place-items-center ring-2 ring-white shadow"
                      >
                        <img v-if="inquiry.professor?.avatarUrl" :src="inquiry.professor.avatarUrl" alt="avatar" class="w-full h-full object-cover" />
